...
function Homebot() {
 ...
 <div className='  flex flex-col justify-center items-center gap-5  min-h-[500px]  p-4 bg-[#F06D4F]' >
       <button className='bg-[#FEFBF2]  flex justify-center items-center text-[#38AD3D] text-[26px] font-bold py-4 px-6  h-[50px] w-[300px] font-fredoka text-center rounded-tl-[20px] rounded-br-[20px]  '>
             ...
             <p className="flex items-center border-2 border-white rounded-lg p-3 mb-4 shadow-md sm:w-96 text-white w-[380px]">
          <i className="fas fa-book text-white mr-3"></i>
          Provide value-based education
        </p>
        <p className="flex items-center border-2 border-white rounded-lg p-3 mb-4 shadow-md sm:w-96 w-[380px] text-white">
