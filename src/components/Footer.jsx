...
{/* second portion */}
    ...
    <h3 className="text-lg md:text-md font-medium  cursor-pointer text-white font-league-spartan">News & Events</h3>
     ...
     <h3 className="text-lg md:text-md font-medium  cursor-pointer text-white font-league-spartan">Gallery</h3>
      ...
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white font-league-spartan">Daycare</h3>
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white font-league-spartan">Pre-KG</h3>
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white font-league-spartan">LKG/UKG</h3>
      <h3 className="text-lg md:text-md font-medium  cursor-pointer text-white font-league-spartan">Tution(LKG to +2)</h3>
      <h3 className="text-lg md:text-md font-medium  cursor-pointer text-white font-league-spartan">Handwriting Development</h3>
                </div>
      ...
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white ml-2 font-league-spartan ">National nagar,Kallattumukku</h3>
    </div> 
    <div className="flex items-center">
      <span><img width="16" height="16" src="https://img.icons8.com/tiny-glyph/16/FFFFFF/email.png" alt="email"/></span>
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white ml-2 font-league-spartan ">Applekidskindergarten@gmail.com</h3>
    </div> 
    <div className="flex items-center">
      <h3 className="text-lg md:text-md font-medium cursor-pointer text-white ml-2 font-league-spartan ">7736965145 | 8086029291 </h3>
    </div> 
    </div>
